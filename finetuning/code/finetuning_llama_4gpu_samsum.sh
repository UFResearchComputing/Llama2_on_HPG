...
#SBATCH --job-name=llama2-4gpu-samsum
...
torchrun --nnodes 1 --nproc_per_node 4  finetuning.py \
         ...
         --use_peft --peft_method lora --dataset samsum_dataset \
         --save_model --dist_checkpoint_root_folder model_checkpoints \
         --dist_checkpoint_folder fine-tuned --pure_bf16 \
         --output_dir /data/ai/tutorial/Llama2_on_HPG/finetuning/models/4gpu/samsum # Important Note: Please specify the path to your own directory.